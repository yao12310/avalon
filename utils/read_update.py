...
def write_stats():
    ...
    with open(README, 'a') as f:
        ...
        f.write("9. [Kate Good Theorem statistics](#kgt-stats)\n")
        f.write("10. [Player/role counts/percentages](#player-role-cnts-pcts)\n")
        f.write("11. [Percentage of times two players are on the same team](#pair-teams-pct)\n")
        f.write("12. [Percentage of times two players are both bad](#pair-bad-team-pct)\n")        
        f.write("13. [Percentage of times two players are on different teams](#pair-opp-teams-pct)\n")
        f.write("14. [Count of times two players are on the same team](#pair-teams-cnt)\n")
        f.write("15. [Count of times two players are both bad](#pair-bad-team-cnt)\n")        
        f.write("16. [Count of times two players are on different teams](#pair-opp-teams-cnt)\n")
        f.write("17. [Percentage of times two players win, given that they are on the same team](#pair-teams-win-pct)\n")
        f.write("18. [Percentage of times two players win, given that they are both bad](#pair-bad-team-win-pct)\n")        
        f.write("19. [Percentage of times two players win, given that they are on opposite teams](#pair-opp-teams-win-pct)\n")
        f.write("20. [3+1 vs 2+2 strategy success rate](#mission2)\n")
        f.write("21. [Good win rate w.r.t. R1 fail](#r1-fail)\n")
        f.write("22. [Flip statistics for different # bad guys and mission index](#flip-stats)\n")
        f.write("23. [Good win % w.r.t. # Percival claims](#good-win-num-percival)\n")
        f.write("24. [Percentage of time each role fake claims Percival](#role-fake-percival)\n")
        f.write("25. [% of time players are wrongly assassinated as non-Merlin good guy](#wrongly-assassinated)\n")
        ...
        f.write("\n")
        f.write('### <a id="kgt-stats"></a>Kate Good Theorem statistics\n')
        dfs = kgt_stats()
        for df in dfs:
            f.write(tabulate.tabulate(df.values, df.columns, tablefmt="github") + '\n')
            f.write("\n")
        ...
        f.write("Cheesy wins included:\n")
        f.write("\n")  
        df = player_pair_win_pcts(bad=True, ex_ch=False, df=game_log_competitive)
        f.write(tabulate.tabulate(df.values, df.columns, tablefmt="github") + '\n')
        f.write("\n")
        f.write("Cheesy wins excluded:\n")
        f.write("\n")
        df = player_pair_win_pcts(bad=True, ex_ch=True, df=game_log_competitive)
        f.write(tabulate.tabulate(df.values, df.columns, tablefmt="github") + '\n')
